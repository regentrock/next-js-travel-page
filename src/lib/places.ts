...
export const places: Place[] = [
  {
    ...
    O famoso teleférico do Parque Unipraias conecta o mar à mata, proporcionando uma vista inesquecível. À noite, a cidade se transforma em um centro vibrante, com bares, restaurantes e casas noturnas de alto padrão.`
  },
  {
    id: 2,
    title: "Paris",
    ...
    Caminhar pelas margens do Rio Sena, visitar o Museu do Louvre e se perder nas ruas de Montmartre são experiências que definem o verdadeiro espírito parisiense. 
    A gastronomia local é um espetáculo à parte — cafés, boulangeries e restaurantes tradicionais convidam a saborear croissants, vinhos e queijos franceses autênticos.`
  },
  {
    id: 3,
    ...
    Suas ruelas estreitas e praças de pedra guardam igrejas antigas, palácios e vistas espetaculares do mar azul-turquesa. 
    Famosa por ter sido cenário da série “Game of Thrones”, Dubrovnik encanta pela combinação entre história viva, cultura vibrante e hospitalidade calorosa.`
  },
  {
    id: 4,
    ...
    O Pão de Açúcar oferece uma das vistas mais espetaculares do Brasil, e a Lapa pulsa ao som do samba e da boemia carioca. 
    Seja para relaxar, explorar ou se apaixonar pela vida, o Rio é um destino inesquecível.`
  },
  {
    id: 5,
    title: "Tóquio",
    ...
    O bairro de Shibuya é o coração pulsante da cidade, enquanto Asakusa preserva o espírito do Japão antigo. 
    A culinária é um espetáculo à parte — dos sushis artesanais aos mercados de rua, cada refeição é uma experiência sensorial. 
    Em Tóquio, tradição e inovação caminham lado a lado em harmonia perfeita.`
  },
  {
    id: 6,
    title: "Roma",
    ...
    No coração do Vaticano, a Basílica de São Pedro e a Capela Sistina revelam obras-primas de Michelangelo. 
    Além da arte e da arquitetura, Roma conquista pelo sabor — massas frescas, vinhos locais e o irresistível gelato fazem parte da experiência romana autêntica.`
  }
];
